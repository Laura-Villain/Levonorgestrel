...
The presented model represents an original model development project presented by Cicali *et al.* [1]. 
A complete summary of model development and application can be found in this manuscript and respective supplemental materials.
